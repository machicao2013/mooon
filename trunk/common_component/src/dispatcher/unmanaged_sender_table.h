...
public:
    ...
    bool send_message(const net::ipv4_node_t& ip_node, dispatch_message_t* message);
    bool send_message(const net::ipv6_node_t& ip_node, dispatch_message_t* message);
...
private:        
    ...
    template <typename ip_node_t>
    bool do_send_message(const ip_node_t& ip_node, dispatch_message_t* message);
